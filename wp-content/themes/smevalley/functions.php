...
require get_template_directory().'/widget/picNews.php';
require get_template_directory().'/widget/carousel.php';
require get_template_directory().'/widget/nav.php';
require get_template_directory().'/widget/introduce.php';
require get_template_directory().'/widget/valleyNews.php';
require get_template_directory().'/widget/valleyUs.php';
...
if ( function_exists( 'add_image_size' ) ) {
	...
	add_image_size( 'smevalley', 307, 227,true );
}
