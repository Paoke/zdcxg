 ...
 * 新闻滚动
 * */
class CarouselViews extends WP_Widget{
	function CarouselViews(){

		$widget_ops = array('classname'=>'','description'=>'新闻滚动');
		$this->WP_Widget($id_base = "carsoule",'新闻滚动',$widget_ops);
	}
	function form($instance){
		...
		<?php
			...
			<p><label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_attr_e('每次滑动的个数,默认为1:'); ?> 
